...
namespace Framework462.TestProject
{
    [TestFixture]
    public class SuccinctViaNugetTests
    {
        [Test]
        public void ProjectUsingFramework462_CanRunAgainstSuccinctFromNuget()
        {
        ...
        [Test]
        public void ProjectUsingFramework462_GetsTheCorrectVersionOfSuccinctFromNuget()
        {
            Option<int>.Some(1);
