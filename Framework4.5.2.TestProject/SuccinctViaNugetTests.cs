...
namespace Framework452.TestProject
{
    [TestFixture]
    public class SuccinctViaNugetTests
    {
        [Test]
        public void ProjectUsingFramework452_CanRunAgainstSuccinctFromNuget()
        {
        ...
        [Test]
        public void ProjectUsingFramework452_GetsTheCorrectVersionOfSuccinctFromNuget()
        {
            Option<int>.Some(1);
